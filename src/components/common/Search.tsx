...
// Components
import HomeFlightsSearch from "@/components/flights/homepage-search";
import HomeHotelssSearch from "@/components/hotels/homepage-search";
// UI
    ...
    <div className="w-[80%] max-[767px]:w-[100%] mx-auto">
      <Tabs defaultValue="flights" className="!gap-0">
        <TabsList className="w-full bg-white !justify-end !pb-0 !rounded-t-2xl !rounded-b-none">
          <TabsTrigger value="hotels" className="flex-[0]">
            {t("Tabs.hotels")}
          </TabsTrigger>

          <TabsTrigger value="flights" className="flex-[0]">
            {t("Tabs.flights")}
          </TabsTrigger>
        </TabsList>
